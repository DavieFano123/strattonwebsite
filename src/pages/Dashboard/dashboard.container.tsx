            ...
            <div className="publishing-section">
                <div className="w-100">
                    <div className="left">
                        ...
                        <p>Download our free publishing guide to learn about our self-publishing process and services.</p>
                    </div>
                    <div className="right">
                ...
                <div className="learnmore-section">
                    <div className="about-us">
                        <div className="col">
                            ...
                            <button type="button" className="btn btn-success"  onClick={() => goToAboutUs()}>Learn More!</button> 
                        </div>
                        <div className="col">
                            <img src={Package} className="packages-img" alt="..." />
                            <label className="">Our Publishing Packages</label>
                            <p className="align-middle pt-0">
                            ...
                            <button type="button" className="btn btn-warning" onClick={() => goToPublish()}>View Packages</button> 
                        </div>
                        <div className="col">
                            ...
                            <div className="top">
                                <div className="flex-r">
                                    ...
                                    <div className="right">
                                        ...
                                        <div className="ttl-flex"><a href="https://haldavisusmcret.com" target="_blank">Check out Hal's Website</a></div>
                                    </div>
                                </div>
                            </div>
