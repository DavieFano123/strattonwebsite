                            ...
                            <div className="contact-container">
                                <div className="left">
                                    ...
                                    <div className="contact-main">
                                        ...
                                        <p>Do you have questions or concerns about self-publishing? Just leave a message and we’ll get back to you the soonest.</p>
                                       
                                            <div className="input-con">
                                            <input type="text" className="name" placeholder="Fullname" />
                                            <br />
                                            ...
                                            <select className="dropdown" name="manuscript" id="cars" placeholder="Want to know more">
                                            ...
                                            <textarea className="textarea" id="" placeholder="Your Message"></textarea>
                                            <br />
