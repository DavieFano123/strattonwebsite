                ...
                <div className="w-100">
                    ...
                    <div className="container">
                        ...
                        <div className="right">
                            ...
                            <p>
                                Even the best of writers need good copyeditors. We do a 3-step rigorous process that include development editing, copy editing and proofreading. If you have supplied some citations, footnotes, or end notes, we can properly lay those out too, into your book.
                            </p>
                        </div>
                    </div>
                    <div className="container">
                        ...
                        <div className="right">
                            ...
                            <p>
                                Preparing your book's interior, entail professional work. We will ensure your pages are correctly arranged, your images properly positioned, your text in the best format - all to effect a great experience for your readers. Your content is kind, so let's make is shine. Leave the nitty gritty to us.
                            </p>
                        </div>
                    </div>
                    <div className="container">
                        ...
                        <div className="right">
                            ...
                            <p>
                                For an easy read, do you want your book accessible as an e-book? Or a hardback copy shippable by Amazon? Be it paperback, hardback, or an electronic book form - we can offer all these options for ease and varying preference of your potential readers.
                            </p>
                        </div>
                    </div>
                    <div className="container">
                        ...
                        <div className="right">
                            ...
                            <p>
                                When your book is ready, we’ll assign a unique ISBN for your title. This now allows your work to be showcased for the world to access. Have an international distribution through Amazon, Barnes and Noble, Lightning Source, Chapters, Indigo and other online retailers.
                            </p>
                        </div>
                    </div>
                    <div className="container">
                        ...
                        <div className="right">
                            ...
                            <p>
                                It’s a new world now and the internet has become a global marketplace. Having your own website and creating a social media presence for you and your book gets you “out there”. Don’t worry, we can set them up for you, and if you need so, we can manage it too.
                            </p>
                        </div>
                    </div>
                    <div className="container">
                        ...
                        <div className="right">
                            ...
                            <p>
                                ...
                                <br />
                                <br />
                                Widely-known US Review of Books can also give an unbiased review of your book<br />
                    ...
                    <div className="container">
                        ...
                        <div className="right">
                            <h1>Screenplay</h1>
                            <p>
                                Do you feel that your book can be the next movie success? Let Stratton Press improve your chances by transposing your book into screenplay form that agents, movie writers, producers and directors would appreciate
                            </p>
                        </div>
                    </div>
                    <div className="container">
                    ...
                    <div className="container">
                        ...
                        <div className="right">
                            ...
                            <p>
                                Do you think your book has a special niche with a foreign market? We can have your book translated in Japanese, German and French.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div className="publish-5" id="publish-5">
                <div className="w-100">
                    <div className="flex">
                        ...
                        <div className="right">
                            <Carousel autoplay={true} wrapAround={true} className="carousel" height="650" withoutControls={false} >
                                <div>
                                    ...
                                    <span>Jean I.</span>
                                    <label>&lt;Showing Our 5 and 5 star Reviews&gt;</label>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p>
                                        ...
                                        So far Stratton is wonderful to work with-so far everyone I have talked to has been extremely polite and sympathetic to my goals. Only probables..they need to have a Fax available. Lots of people still use it. **** ***** *******
                                ...
                                <div>
                                    ...
                                    <p>
                                     I am very pleased with the staff of Stratton Press. I'm a new author and this is a new experience for me. Jerry T******* guided me through all the processes necessary to publish my book.. I highly recommend Stratton Press for all writers, old or new.
                                    </p>
                                    <span>Shanna E</span>
                                    <label>&lt;Showing Our 5 and 5 star Reviews&gt;</label>
                                </div>
                            ...
                            I have been working with Stratton Press for a little more than 6 months and I find their customer service to be excellent. They are in constant contact with me and I am in the process of getting a second book published with them.
